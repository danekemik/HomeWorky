...
- 🎛 Управление группой для старосты: список участников с удалением,
  переименование группы, перевыпуск инвайт-кода, управление предметами
  (переименование/удаление) и настройка времени вечернего напоминания
  (18:00–22:00 или по умолчанию).
